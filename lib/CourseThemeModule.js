...
class CourseThemeModule extends AbstractApiModule {
  ...
  async processFileVariables(fwBuild) {
    ...
    fwBuild.courseData.course.data.themeVariables._font._fontAssignments._instruction["instruction-font-style"] = fontData._fontAssignments._instruction._isInstructionItalic ? 'italic' : 'normal';
